...
img=ImageReader('output/escarapelas-comunidad-verde-v3.png')
iw,ih=img.getSize()
c=canvas.Canvas('output/pdf/escarapelas-carta-v3.pdf',pagesize=(612,792))
...
for i,(x0,y0,x1,y1) in enumerate(boxes):
    ...
    c.restoreState()
c.showPage(); c.save()
r=PdfReader('output/pdf/escarapelas-carta-v3.pdf')
