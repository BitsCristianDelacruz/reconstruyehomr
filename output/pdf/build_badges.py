...
img=ImageReader('output/escarapelas-comunidad-verde.png')
iw,ih=img.getSize()
c=canvas.Canvas('output/pdf/escarapelas-carta.pdf',pagesize=(612,792))
c.setTitle('Comunidad Verde - cinco escarapelas de 9 x 6 cm')
boxes=[(52,107,544,491),(556,107,1049,491),(52,503,544,887),(556,503,1049,887),(52,899,544,1285)]
w,h=9*cm,6*cm
gap=.6*cm
left=(612-2*w-gap)/2
top=(792+3*h+2*gap)/2
for i,(x0,y0,x1,y1) in enumerate(boxes):
    ...
    c.restoreState()
c.showPage(); c.save()
r=PdfReader('output/pdf/escarapelas-carta.pdf')
